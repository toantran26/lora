                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Thông tin chi tiết GateWay : <?php echo e($data->name); ?> </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body table-responsive p-0">
                            <div class="row width-800 pt-4 pb-4 <?php echo e($data->code); ?>">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('input[name="relay_1"]').on('switchChange.bootstrapSwitch', function (event, state) {
                if (state === true) {
                    // Checkbox được bật
                    public('<?php echo e($data->code."/".$data->remote); ?>','on1');
                    $(this).parents('.box-light').addClass('active');
                    console.log('Checkbox được bật');
                } else {
