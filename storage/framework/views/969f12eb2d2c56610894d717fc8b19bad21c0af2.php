                    ...
                    <div class="float-right">
                      <form class="card-tools" action="">
                        <div class="input-group input-group-sm" style="width: 350px;">
                            <input type="text" name="keyword" value="<?php echo e(@$_GET['keyword']); ?>" class="form-control float-right" placeholder="Search">
                            ...
                            <td>
                              <div class=" text-center">
                                ...
                                <ul class="dropdown-menu" id="dropdown<?php echo e($value->id); ?>">
                                  <li>
                                    <a class="btn_edit" data-id="<?php echo e($value->id); ?>" href="<?php echo e(route('edit-node',['id'=>$value->id])); ?>">
                                      <i class="fas fa-edit"></i>
                                      Chỉnh sửa
                                    </a>
                                  </li>
                                  <li class="remove-button">
                                    <a class="delete-node" data-toppic="remove#<?php echo e(hexdec($value->code)); ?>" data-push="<?php echo e($value->gateway->code.'/'.$value->gateway->remote); ?>"
