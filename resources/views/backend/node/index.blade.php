                          ...
                          <th>Kênh điều khiển</th> --}}
                                ...
                                <tbody>
                                    @foreach ($listNode as $key => $value)
                                        <tr>
                                            <td><a data-id="{{$value->id}}" href="{{route('detail-node',['id'=>$value->id])}}">{{ $value->name }} <a></td>
                                            <td>{{ $value->code }}</td>
                                            <td>{{ $value->gateway->name }}</td>
                                            <td>{{($value->type == 1) ?'AN (điều kiển)':'SN nhận dữ liệu' }}</td>
                                            ...
                                            <td>
                                                <div class=" text-center">
                                                    ...
                                                    <ul class="dropdown-menu" id="dropdown{{ $value->id }}">
                                                      <li>
                                                        <a data-id="{{$value->id}}" href="{{route('detail-node',['id'=>$value->id])}}">
                                                          <i class="fas fa-info-circle"></i>
                                                              Chi tiết
                                                        </a>
                                                      </li>
                                                        <li>
                                                            <a class="btn_edit" data-id="{{ $value->id }}"
                                                                href="{{ route('edit-node', ['id' => $value->id]) }}">
                                                        ...
                                                        <li class="remove-button">
                                                            <a class="delete-node"
                                                                data-toppic="remove#{{ hexdec($value->code) }}"
                                                                data-push="{{ $value->gateway->code . '/' . $value->gateway->remote }}"
