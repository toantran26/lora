...
<div class="modal-dialog" data-width="600">
    <div class="modal-content">
        <form action="{{route('update-gateway',['id'=>$data->id])}}" method="post" id="form_category">
        @method('post')
        @csrf
        <input hidden name="id" value="{{$data->id}}">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Sửa thông tin gateway - <span class="name-title-header">{{$data->name}}</span> </h5>
