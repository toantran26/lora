    ...
    <ul class="navbar-nav ml-auto">
        ...
        {{-- <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{request()->getSchemeAndHttpHost()}}/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{request()->getSchemeAndHttpHost()}}/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                John Pierce
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{request()->getSchemeAndHttpHost()}}/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                Nora Silvester
        ...
        <li class="dropdown user nav-item">
            ...
            <ul class="dropdown-menu">
                {{-- <li><a href="?mod=user&amp;act=profile"><i class="icon-user"></i> Hồ sơ cá nhân</a></li>
                <li class="divider"></li>
                <li><a href="?mod=user"><i class="icon-group"></i> Quản lý tài khoản</a></li>
                <li><a href="?mod=setting"><i class="icon-cogs"></i> Cài đặt</a></li>
                <li><a href="?mod=ads"><i class="icon-bullhorn"></i> Quản lý quảng cáo</a></li>
                <li class="divider"></li> --}}
                <li class="nav-item">
